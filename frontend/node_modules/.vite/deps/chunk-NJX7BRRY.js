...
var _excluded3 = ["anchor", "classes", "className", "width", "style"];
...
var SwipeArea = React3.forwardRef(function SwipeArea2(props, ref) {
  const {
    anchor,
    classes = {},
    className,
  ...
  return (0, import_jsx_runtime3.jsx)(SwipeAreaRoot, _extends({
...
var SwipeableDrawer = React4.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  const {
    ...
    variant = "temporary"
    // Mobile first.
  } = props, ModalPropsProp = _objectWithoutPropertiesLoose(props.ModalProps, _excluded4), other = _objectWithoutPropertiesLoose(props, _excluded23);
  const [maybeSwiping, setMaybeSwiping] = React4.useState(false);
  const swipeInstance = React4.useRef({
    isSwiping: null
  });
  const swipeAreaRef = React4.useRef();
  const backdropRef = React4.useRef();
  const paperRef = React4.useRef();
  const handleRef = useForkRef_default(PaperProps.ref, paperRef);
  const touchDetected = React4.useRef(false);
  const calculatedDurationRef = React4.useRef();
  useEnhancedEffect_default(() => {
    calculatedDurationRef.current = null;
  }, [open]);
  const setPosition = React4.useCallback((translate, options = {}) => {
    const {
      mode = null,
  ...
  return (0, import_jsx_runtime5.jsxs)(React4.Fragment, {
    children: [(0, import_jsx_runtime4.jsx)(Drawer_default, _extends({
      ...
      onClose,
      ref
    }, other)), !disableSwipeToOpen && variant === "temporary" && (0, import_jsx_runtime4.jsx)(NoSsr, {
      children: (0, import_jsx_runtime4.jsx)(SwipeArea_default, _extends({
        anchor,
        ref: swipeAreaRef,
...
//# sourceMappingURL=chunk-NJX7BRRY.js.map

...
const SearchedProduct = () => {
  ...
  const { searched_value } = useParams();

  const { isLoading, data } = useGetProductBySearchQuery(searched_value, {
    skip: !searched_value,
  });
  ...
  return (
    <div className="pt-[4rem] cu500:pt-[4.4rem]">
      <div className="text-xl sm:text-2xl md:text-3xl mx-2 my-8  cu500:mx-6 font-bold flex items-center ">
        <CiSearch /> <h1> {searched_value}</h1>{" "}

  ...
  return (
    <div className="mt-[4.4rem]">
      {wishlistData && wishlistData.length > 0 ? (
        <div>
          <h2 className="text-xl sm:text-2xl text-slate-700 mx-4 sm:mx-10 pb-1 py-7 font-semibold">
            My Wish List
          </h2>
                ...
                return (
                  <Fragment key={val.id}>
                    ...
                    >
                      ...
                      >
                        <LazyImage
                          className="peer absolute top-0 right-0  w-full object-cover h-[200px] cu500:h-[280px] "
                          src={val.thumbnail}
                          alt="product image"
                        />
                        <img
                      ...
                      <button
                        className="absolute -top-1 -right-1 bg-black px-1 py-1 text-center text-[12px] font-medium "
                        onClick={() => WishList(val)}
                      >
                        <RxCrossCircled className="text-2xl text-white  " />
                      </button>
